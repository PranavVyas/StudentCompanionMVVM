...
public interface AttendanceDao {
    ...
    @Query("SELECT COUNT(_ID) FROM attendanceindividual WHERE subjectName = :subName AND date <= :endDate AND date >= :startDate AND NOT present = '0'")
    int getTotalDaysForSubject(String subName, Date startDate, Date endDate);
